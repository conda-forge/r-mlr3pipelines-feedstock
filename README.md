...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-mlr3pipelines-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-mlr3pipelines-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-mlr3pipelines
# for installing globally
pixi global install r-mlr3pipelines
```
...
It is possible to list all of the versions of `r-mlr3pipelines` available on your platform:
...
```
pixi search r-mlr3pipelines --channel conda-forge
```
